...
func (dr *DocumentRequester[DocumentT]) ListAll(buf *[]DocumentT, options *DocumentListOptions) (err error) {
...
func (dr *DocumentRequester[DocumentT]) ListAllIterator(items chan<- DocumentT, options *DocumentListOptions) error {
	var err error
	if items == nil {
	...
	resp, err := dr.Client.implClient.Do(req)
	if err != nil {
		return err
	}
...
func (dr *DocumentRequester[DocumentT]) Get(buf *DocumentT, docID string, options *DocumentGetOptions) (err error) {
	if options, err = prepareOptions(options); err != nil {
		return err
	}
	extraParams := struct {
...
func (dr *DocumentRequester[DocumentT]) Create(doc DocumentT, options *DocumentCreateOptions) error {
	var docSlice []DocumentT
	docSlice = append(docSlice, doc)
	if _, err := dr.CreateBulk(docSlice, options); err != nil {
		return err
	}
	return nil
}

func (dr *DocumentRequester[DocumentT]) CreateBulk(docs []DocumentT, options *DocumentCreateOptions) (insertedIDs []string, err error) {
	if options, err = prepareOptions(options); err != nil {
		return nil, err
	}
	...
	if _, err = doRequest(sl, &insertedIDs); err != nil {
		return nil, err
	}
	return
}
...
func (dr *DocumentRequester[DocumentT]) UpdateBulk(docs []DocumentT, options *DocumentUpdateOptions) (updatedIDs []string, err error) {
	if options, err = prepareOptions(options); err != nil {
		return nil, err
	}
	// TODO: maybe need to implement _convert_document function and use here
	...
	if _, err = doRequest(sl, &updatedIDs); err != nil {
		return nil, err
	}
	return
}

func (dr *DocumentRequester[DocumentT]) Update(doc DocumentT, options *DocumentUpdateOptions) error {
	var docSlice []DocumentT
	docSlice = append(docSlice, doc)
	if _, err := dr.UpdateBulk(docSlice, options); err != nil {
		return err
	}
	return nil
}
...
func (dr *DocumentRequester[DocumentT]) DeleteBulk(docIDs []string, options *DocumentDeleteOptions) (deletedIDs []string, err error) {
	if options, err = prepareOptions(options); err != nil {
		return nil, err
	}
	// TODO: maybe need to implement _convert_document function and use here
	...
	if _, err = doRequest(sl, &deletedIDs); err != nil {
		return nil, err
	}
...
func (dr *DocumentRequester[DocumentT]) Delete(docID string, options *DocumentDeleteOptions) error {
	var docSlice []string
	docSlice = append(docSlice, docID)
	if _, err := dr.DeleteBulk(docSlice, options); err != nil {
		return err
	}
	return nil
}
