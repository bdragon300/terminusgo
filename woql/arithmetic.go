...
func Plus(values ...NumberOrVariable) schema.Plus {
	...
	for _, v := range values {
		params = append(params, *parseVariable(v, &schema.ArithmeticValue{}, true))
	}
...
func Exp(left, right NumberOrVariable) schema.Exp {
	return bare.Exp(
		*parseVariable(left, &schema.ArithmeticValue{}, true),
		*parseVariable(right, &schema.ArithmeticValue{}, true),
	)
}

func Floor(value NumberOrVariable) schema.Floor {
	return bare.Floor(*parseVariable(value, &schema.ArithmeticValue{}, true))
}
